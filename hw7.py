...
If the user enters an integer that is not between 1 - 5, the script will continue asking the user to input a number.
If the user enters a non-integer, for example a float or a string, a value error would be captured and the menu would be displayed again.
